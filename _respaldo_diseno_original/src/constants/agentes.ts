...
export const AGENTES_CONFIG: Record<AgenteId, { nombre: string; cargo: string; emoji: string; color: string; bg: string; icon: any; shadow: string; misionPanaderia: string; plantillas: string[] }> = {
  ...
  'hermes':     { nombre: 'HERMES',         cargo: 'Copiloto Voz',    emoji: '🎤', color: 'text-indigo-400', bg: 'bg-indigo-500/10 border-indigo-500/20', icon: MessageSquare, shadow: 'shadow-indigo-500/40', misionPanaderia: 'Comandas por voz → borrador de pedido (ÍTEMS / NOTA / SIGUIENTE) para facturar rápido.', plantillas: ['Borrador de Comanda por Voz', 'Resumen Rápido de Mostrador'] },
