...
import {
    ...
    getProducciones, addProduccion, deleteProduccion, saveProducciones, recuperarProduccionesLocal, fechaLocalHoy, normalizarFechaYYYYMMDD
...
export function useReportesData(props: ReportesProps) {
    ...
    const [producciones, setProducciones] = useState<RegistroProduccion[]>(() => {
        try { recuperarProduccionesLocal(); } catch { /* ignore */ }
