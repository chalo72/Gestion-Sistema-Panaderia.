        ...
        <div className="space-y-6 animate-ag-fade-in pb-10">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6">
                <div className="space-y-1">
                    <h1 className="text-2xl sm:text-4xl font-black text-foreground flex items-center gap-3 sm:gap-4 tracking-tight">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 kpi-violet rounded-2xl flex items-center justify-center shadow-lg shadow-violet-500/20 rotate-3 shrink-0">
                            <ChefHat className="w-5 h-5 sm:w-7 sm:h-7 text-white" />
                        </div>
                        Libreta del Horno
                    </h1>
                    <p className="text-sm sm:text-base text-muted-foreground font-medium flex items-center gap-2 pl-1">
            ...
            {/* Guía rápida — en celular se oculta si ya estás en Libreta (menos ruido) */}
            <div className={cn(
                "rounded-3xl border-2 border-amber-500/25 bg-amber-500/5 p-4 sm:p-5 mb-4 space-y-3",
                activeTab === 'plan-diario' && 'hidden sm:block'
            )}>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                <TabsList className="bg-muted/40 p-1.5 rounded-2xl flex items-center justify-start gap-1 w-full max-w-5xl mx-auto overflow-x-auto no-scrollbar min-h-[56px]">
                    {/* ── Flujo principal (lo que usa el horno) ── */}
                    <TabsTrigger value="plan-diario" className="rounded-xl min-h-[44px] px-3 data-[state=active]:bg-amber-600 data-[state=active]:text-white data-[state=active]:shadow gap-1.5">
                        <ChefHat className="w-4 h-4" />
                        <span className="font-black text-[11px]">Libreta</span>
                    </TabsTrigger>
                    <TabsTrigger value="historial-panes" className="rounded-xl min-h-[44px] px-3 data-[state=active]:bg-emerald-600 data-[state=active]:text-white data-[state=active]:shadow gap-1.5">
                        <ClipboardList className="w-4 h-4" />
                        <span className="font-black text-[11px]">Historial</span>
                    </TabsTrigger>
                    <TabsTrigger value="ordenes" className="rounded-xl min-h-[44px] px-3 data-[state=active]:bg-orange-500 data-[state=active]:text-white data-[state=active]:shadow gap-1.5">
                        <Flame className="w-4 h-4" />
                        <span className="font-black text-[11px]">Hornear</span>
                    </TabsTrigger>
                    <TabsTrigger value="plan-avanzado" className="rounded-xl min-h-[44px] px-3 data-[state=active]:bg-indigo-600 data-[state=active]:text-white data-[state=active]:shadow gap-1.5">
                    ...
                    <TabsTrigger value="formulaciones" className="rounded-xl data-[state=active]:bg-white dark:data-[state=active]:bg-slate-800 data-[state=active]:shadow gap-1.5">
                        ...
                        <span className="text-[11px] font-bold">Recetas</span>
                    </TabsTrigger>
                    <TabsTrigger value="modelos" className="rounded-xl data-[state=active]:bg-white dark:data-[state=active]:bg-slate-800 data-[state=active]:shadow gap-1.5">
                        ...
                        <span className="text-[11px] font-bold">Modelos Pan</span>
                    </TabsTrigger>
