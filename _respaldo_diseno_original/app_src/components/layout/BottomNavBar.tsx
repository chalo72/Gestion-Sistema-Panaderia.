...
export function BottomNavBar({ currentView, onViewChange, alertasNoLeidas, onOpenMenu }: BottomNavBarProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-slate-900/90 backdrop-blur-lg border-t border-slate-800/50 md:hidden flex items-center justify-around pt-2 px-2 min-h-[72px] h-[calc(72px+env(safe-area-inset-bottom,0px))] pb-[env(safe-area-inset-bottom,0px)]">
