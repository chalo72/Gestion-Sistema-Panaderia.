...
const MODULOS_APP: ModuloStats[] = [
  { nombre: 'Centro de Mando', ruta: '/dashboard', visitas: 0, ultimaVisita: '', color: 'text-slate-300' },
  { nombre: 'Equipo & Checklist', ruta: '/comunicaciones', visitas: 0, ultimaVisita: '', color: 'text-sky-400' },
  { nombre: 'Ventas', ruta: '/ventas', visitas: 0, ultimaVisita: '', color: 'text-emerald-400' },
  { nombre: 'Historial Ventas', ruta: '/historial-ventas', visitas: 0, ultimaVisita: '', color: 'text-emerald-300' },
  ...
  { nombre: 'Créditos', ruta: '/creditos', visitas: 0, ultimaVisita: '', color: 'text-pink-300' },
  { nombre: 'Proveedores', ruta: '/proveedores', visitas: 0, ultimaVisita: '', color: 'text-purple-400' },
  { nombre: 'Nómina', ruta: '/trabajadores', visitas: 0, ultimaVisita: '', color: 'text-cyan-400' },
  { nombre: 'Reportes', ruta: '/reportes', visitas: 0, ultimaVisita: '', color: 'text-indigo-400' },
  { nombre: 'Gastos', ruta: '/gastos', visitas: 0, ultimaVisita: '', color: 'text-rose-400' },
  { nombre: 'Agentes IA', ruta: '/agentes-ia', visitas: 0, ultimaVisita: '', color: 'text-[#DAA520]' },
  { nombre: 'Videovigilancia', ruta: '/videovigilancia', visitas: 0, ultimaVisita: '', color: 'text-teal-400' },
  { nombre: 'Auditoría Digital', ruta: '/cctv', visitas: 0, ultimaVisita: '', color: 'text-teal-300' },
    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-900/60 rounded-2xl p-6 border border-white/5">
        <div className="flex items-center justify-between mb-4">
          ...
          >
            {loadingAnalisis ? 'Resumiendo...' : 'Actualizar resumen'}
          </button>
        </div>
        {analisis ? (
          <p className="text-sm text-slate-300 font-bold italic leading-relaxed">{analisis}</p>
        ) : (
          <p className="text-xs text-slate-600 italic">Presiona para ver un resumen local de los módulos más y menos usados (no es una consulta a la IA).</p>
        )}
      </div>
    </div>
  );
