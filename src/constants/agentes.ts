...
export const AGENTES_CONFIG: Record<AgenteId, { nombre: string; cargo: string; emoji: string; color: string; bg: string; icon: any; shadow: string; misionPanaderia: string; plantillas: string[] }> = {
  ...
  nomina:       { nombre: 'NÓMINA & RRHH',   cargo: 'Personal / Quincena', emoji: '👥', color: 'text-[#87CEEB]', bg: 'bg-[#87CEEB]/10 border-[#87CEEB]/20', icon: Users, shadow: 'shadow-[#87CEEB]/20', misionPanaderia: 'Trabajadores, turnos, adelantos y nómina quincenal real.', plantillas: ['Preparar Quincena', 'Lista de Adelantos Pendientes', 'Turnos del Equipo'] },
  ...
  logistica:    { nombre: 'LOGÍSTICA',      cargo: 'Compras / OC',    emoji: '🚚', color: 'text-[#A855F7]', bg: 'bg-[#A855F7]/10 border-[#A855F7]/20', icon: Truck, shadow: 'shadow-[#A855F7]/20', misionPanaderia: 'Proveedores, órdenes de compra y recepciones según faltantes reales.', plantillas: ['Orden de Compra Prioritaria', 'Lista de Proveedores Activos', 'Checklist de Recepción'] },
  ...
  clientes:     { nombre: 'CLIENTES',       cargo: 'Gestor PQR',      emoji: '💬', color: 'text-[#EC4899]', bg: 'bg-[#EC4899]/10 border-[#EC4899]/20', icon: MessageCircle, shadow: 'shadow-[#EC4899]/20', misionPanaderia: 'Maestro de clientes, puntos/lealtad y PQR. Fiados los remite a Créditos.', plantillas: ['Encuesta de Satisfacción del Cliente', 'Estrategia de Recuperación de Clientes', 'Plan de Fidelización: El Fan Panadero'] },
  ...
  creditos:     { nombre: 'CRÉDITOS',       cargo: 'Fiados / Cobro',  emoji: '🏦', color: 'text-[#3B82F6]', bg: 'bg-[#3B82F6]/10 border-[#3B82F6]/20', icon: Building, shadow: 'shadow-[#3B82F6]/20', misionPanaderia: 'Quién debe, cuánto y qué está vencido. Cobro de fiados del barrio.', plantillas: ['Lista de Deudores Prioritarios', 'Plan de Cobro Semanal', 'Alerta de Créditos Vencidos'] },
  ...
  ventas:       { nombre: 'VENTAS ÉLITE',   cargo: 'POS / Mostrador', emoji: '🎯', color: 'text-[#facc15]', bg: 'bg-[#facc15]/10 border-[#facc15]/20', icon: Target, shadow: 'shadow-[#facc15]/20', misionPanaderia: 'Tickets del día, top productos, ticket promedio y tips de mostrador/POS.', plantillas: ['Resumen de Ventas del Día', 'Top Productos para Empujar', 'Lista de Precios B2B Hoteles'] },
  ...
  'pico-claw':  { nombre: 'PICO-CLAW',      cargo: 'Márgenes',        emoji: '🦅', color: 'text-[#FF3366]', bg: 'bg-[#FF3366]/10 border-[#FF3366]/20', icon: TrendingUp, shadow: 'shadow-[#FF3366]/40', misionPanaderia: 'Markup (venta-costo)/costo, alertas <15% y fugas de utilidad.', plantillas: ['Productos con Margen Bajo', 'Ajuste de Precio Sugerido', 'Señal Ventas vs Gastos'] },
  'open-claw':  { nombre: 'OPEN-CLAW',      cargo: 'Sistemas / Sync', emoji: '🛡️', color: 'text-[#00FF99]', bg: 'bg-[#00FF99]/10 border-[#00FF99]/20', icon: Rocket, shadow: 'shadow-[#00FF99]/40', misionPanaderia: 'IndexedDB, sync LOCAL GANA, tombstones, backups y /api/agente.', plantillas: ['Chequeo Offline/Online', 'Checklist Sync y Tombstones', 'Plan de Respaldo Rápido'] },
  ...
  'hermes':     { nombre: 'HERMES',         cargo: 'Copiloto Voz',    emoji: '🎤', color: 'text-indigo-400', bg: 'bg-indigo-500/10 border-indigo-500/20', icon: MessageCircle, shadow: 'shadow-indigo-500/40', misionPanaderia: 'Comandas por voz → borrador de pedido (ÍTEMS / NOTA / SIGUIENTE) para facturar rápido.', plantillas: ['Borrador de Comanda por Voz', 'Resumen Rápido de Mostrador'] },
