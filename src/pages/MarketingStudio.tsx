          ...
          <Card className="border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl">
            ...
            <CardContent className="p-4 space-y-3">
              {STRATEGIES.map(strategy => (
                <div key={strategy.id} onClick={() => setSelectedStrategy(strategy.id)} className={`p-3 rounded-xl border-2 cursor-pointer transition-all ${selectedStrategy === strategy.id ? 'border-fuchsia-500 bg-fuchsia-50 dark:bg-fuchsia-900/20' : 'border-slate-200 dark:border-slate-800'}`}>
                  <h3 className="text-sm font-bold">{strategy.label}</h3>
