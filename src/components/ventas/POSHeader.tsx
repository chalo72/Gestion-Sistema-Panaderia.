                    ...
                    <div className="flex-1 flex items-center gap-1.5 overflow-x-auto no-scrollbar py-0.5">
                        ...
                        {onGoToInventario && (
                            <button
                                ...
                                className="h-8 px-3 rounded-lg flex items-center border border-sky-200 bg-sky-50 text-sky-700 hover:bg-sky-100 transition-all shrink-0 gap-1.5"
            ...
            <div className="flex lg:hidden flex-col border-b border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900">
                ...
                <div className="flex items-center gap-2 px-3 py-2">
                    ...
                    {onGoToInventario && (
                        <button
                            onClick={onGoToInventario}
                            className="w-11 h-11 rounded-2xl flex items-center justify-center border-2 transition-all active:scale-95 shrink-0 border-sky-200 bg-sky-50 text-sky-700 hover:bg-sky-100"
                            title="Inventario Físico"
                        >
